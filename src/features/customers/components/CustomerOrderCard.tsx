    ...
    <Group gap={6} wrap="wrap">
      ...
      {order.invoice && (
        <Badge
          ...
          color={
            INVOICE_STATUS_COLORS[
              order.invoice.status as keyof typeof INVOICE_STATUS_COLORS
            ]
          }
        >
          {
            INVOICE_STATUS_LABELS[
              order.invoice.status as keyof typeof INVOICE_STATUS_LABELS
            ]
          }
        </Badge>
      )}
      ...
      >
        ...
        <Stack gap={6} style={{ minWidth: 0 }}>
          ...
          <Text size="sm" c="dimmed">
            Criado em {createdDate} · Retirada em {pickupDate}
          </Text>
